    ...
    return (
        ...
        <div>
            <div style={{width:"100%",display:"flex",border:"none",justifyContent:"center",fontWeight:"normal",flexDirection:"row"}}>
                <span style={{margin:"10px",wordBreak:"break-all"}}>{LDfrom[ld_ctr]}</span>
                <span style={{margin:"0px"}}>-</span>
                <span style={{margin:"10px",wordBreak:"break-all"}}>{LDto1[ld_ctr]}</span>
            </div>
        </div>
        <div>
    ...
    return(
        <div className="certificatePDF_container" id="gridTable_forSearchPDF">
            <div className="pdf_container" id="convertable_pdf">
                ...
                <p className="top_text"><b>Faculty Name : </b><span id="namePrinted"></span></p>
                <p className="top_text"><b>Faculty Email : </b><span id="emailPrinted"></span></p>
                <p className="top_text"><b>College Department : </b><span id="depPrinted"></span></p>
                ...
                <div className="bot_text_div">
                  <p className="bot_text"><b>Generated by : </b><span id="generatedPrint"></span></p>
                  <p className="bot_text"><b>Date : </b><span id="datePrint"></span></p>
                  <p className="bot_text"><b>Time : </b><span id="timePrint"></span></p>
                </div>
            </div>
