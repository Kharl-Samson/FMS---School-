                    ...
                    <div className='content'>
                        <div className='left'>
                            ...
                            <div className='span_cont'>
                                ...
                                <span className='skeleton_done'>{res.age+" years old"}</span>
                            </div>
                        </div>     
                        
                        <div className='left'>
                            <Skeleton animation="wave" className='skeleton_show' style={{marginLeft:"20px"}}/>
                            <Skeleton animation="wave" className='skeleton_show' style={{marginLeft:"20px"}}/>
                            <div className='span_cont'>
                                <span className='skeleton_done'>PLACE OF BIRTH</span>
                                <span className='skeleton_done'>{res.cob+", "+res.pob}</span>
                            </div>
                            <Skeleton animation="wave" className='skeleton_show' style={{marginLeft:"20px"}}/>
                            <Skeleton animation="wave" className='skeleton_show' style={{marginLeft:"20px"}}/>
                            <div className='span_cont'>
                    ...
                    <div className='box'  style={{width:"100%",margin:"0",marginTop:"20px"}}>
                        ...
                        <div className='content'>
                            ...
                            <div className='left'>
                                ...
                                <Skeleton animation="wave" className='skeleton_show' style={{marginLeft:"20px"}}/>
                                <div className='span_cont'>
                                    <span className='skeleton_done'>Alternate Email Address</span>
                                    <span style={{textTransform:"none",fontSize:".9rem"}} className='skeleton_done'>{res.alEmail}</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
elem_ctr++;
    return (   
        <div key={elemName+elem_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>Elementary</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Name of School</span>
                        <span>{elemName[elem_ctr] == '' ? "N/A" :elemName[elem_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                    ...
                    <div className='span_cont'>
                        ...
                        <span>{elemUNITS[elem_ctr] == '' ? "N/A" : elemUNITS[elem_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>SCHOLARSHIP / ACADEMIC HONORS RECEIVED</span>
                        <span>{elemAWARD[elem_ctr] == '' ? "N/A" : elemAWARD[elem_ctr] }</span>
                    </div>
                </div>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Period of Attendance (From)</span>
                        <span>{elemfrom[elem_ctr] == '' ? "N/A" : elemfrom[elem_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                    ...
                    <div className='span_cont'>
                        ...
                        <span>{elemYEAR[elem_ctr] == '' ? "N/A" : elemYEAR[elem_ctr] }</span>
                    </div>
                </div>
            </div>                               
        </div>
...
const SecondaryContent= SecondName.map(()=> {
    ...
    return (   
        <div key={SecondName+sec_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>Secondary</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Name of School</span>
                        <span>{SecondName[sec_ctr] == '' ? "N/A" : SecondName[sec_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Basic education/ Degree/ Course</span>
                        <span>{SecondAttain[sec_ctr] == '' ? "N/A" : SecondAttain[sec_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Highest Level/ Units Earned</span>
                        <span>{SecondUnit[sec_ctr] == '' ? "N/A" : SecondUnit[sec_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>SCHOLARSHIP / ACADEMIC HONORS RECEIVED</span>
                        <span>{SecondAward[sec_ctr] == '' ? "N/A" : SecondAward[sec_ctr] }</span>
                    </div>
                </div>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Period of Attendance (From)</span>
                        <span>{SecondFrom[sec_ctr] == '' ? "N/A" : SecondFrom[sec_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                    <span>Period of Attendance (To)</span>
                    ...
                    <div className='span_cont'>
                        <span>Year Graduate</span>
                        <span>{SecondYear[sec_ctr] == '' ? "N/A" : SecondYear[sec_ctr] }</span>
                    </div>
                </div>
            </div>                               
        </div>
...
const VocationalContent= VocationalName.map(()=> {
    voc_ctr++;
        return (   
            <div key={voc_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>Vocational</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Name of School</span>
                        <span>{VocationalName[voc_ctr] == '' ? "N/A" : VocationalName[voc_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Basic education/ Degree/ Course</span>
                        <span>{VocationalAttain[voc_ctr] == '' ? "N/A" : VocationalAttain[voc_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Highest Level/ Units Earned</span>
                        <span>{VocationalUnit[voc_ctr] == '' ? "N/A" : VocationalUnit[voc_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>SCHOLARSHIP / ACADEMIC HONORS RECEIVED</span>
                        <span>{VocationalAward[voc_ctr] == '' ? "N/A" :VocationalAward[voc_ctr] }</span>
                    </div>
                </div>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Period of Attendance (From)</span>
                        <span>{VocationalFrom[voc_ctr] == '' ? "N/A" :VocationalFrom[voc_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                    <span>Period of Attendance (To)</span>
                    <span>{VocationalTo[voc_ctr] == '' ? "N/A" :VocationalTo[voc_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Year Graduate</span>
                        <span>{VocationalYear[voc_ctr] == '' ? "N/A" :VocationalYear[voc_ctr] }</span>
                    </div>
                </div>
            </div>                               
        </div>
...
const CollegeContent= CollegeName.map(()=> {
    col_ctr++;
        return (   
            <div key={col_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>College</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Name of School</span>
                        <span>{CollegeName[col_ctr] == '' ? "N/A" : CollegeName[col_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Basic education/ Degree/ Course</span>
                        <span>{CollegeAttain[col_ctr] == '' ? "N/A" : CollegeAttain[col_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Highest Level/ Units Earned</span>
                        <span>{CollegeUnit[col_ctr] == '' ? "N/A" : CollegeUnit[col_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>SCHOLARSHIP / ACADEMIC HONORS RECEIVED</span>
                        <span>{CollegeAward[col_ctr] == '' ? "N/A" :CollegeAward[col_ctr] }</span>
                    </div>
                </div>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Period of Attendance (From)</span>
                        <span>{CollegeFrom[col_ctr] == '' ? "N/A" :CollegeFrom[col_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                    <span>Period of Attendance (To)</span>
                    <span>{CollegeTo[col_ctr] == '' ? "N/A" :CollegeTo[col_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Year Graduate</span>
                        <span>{CollegeYear[col_ctr] == '' ? "N/A" :CollegeYear[col_ctr] }</span>
                    </div>
                </div>
            </div>                               
        </div>
...
const GraduateContent= GraduateName.map(()=> {
    ...
    return (   
        <div key={grad_ctr}>
        <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>Graduate Studies</p>
        <div className='content'>
            <div className='left'>
                <div className='span_cont' style={{marginTop:"-20px"}}>
                    <span>Name of School</span>
                    <span>{GraduateName[grad_ctr] == '' ? "N/A" : GraduateName[grad_ctr] }</span>
                </div>
                <div className='span_cont'>
                    <span>Basic education/ Degree/ Course</span>
                    <span>{GraduateAttain[grad_ctr] == '' ? "N/A" : GraduateAttain[grad_ctr] }</span>
                </div>
                <div className='span_cont'>
                    <span>Highest Level/ Units Earned</span>
                    <span>{GraduateUnit[grad_ctr] == '' ? "N/A" : GraduateUnit[grad_ctr] }</span>
                </div>
                <div className='span_cont'>
                    <span>SCHOLARSHIP / ACADEMIC HONORS RECEIVED</span>
                    <span>{GraduateAward[grad_ctr] == '' ? "N/A" :GraduateAward[grad_ctr] }</span>
                </div>
            </div>
            <div className='left'>
                <div className='span_cont' style={{marginTop:"-20px"}}>
                    <span>Period of Attendance (From)</span>
                    <span>{GraduateFrom[grad_ctr] == '' ? "N/A" :GraduateFrom[grad_ctr] }</span>
                </div>
                <div className='span_cont'>
                <span>Period of Attendance (To)</span>
                <span>{GraduateTo[grad_ctr] == '' ? "N/A" :GraduateTo[grad_ctr] }</span>
                </div>
                <div className='span_cont'>
                    <span>Year Graduate</span>
                    <span>{GraduateYear[grad_ctr] == '' ? "N/A" :GraduateYear[grad_ctr] }</span>
                </div>
            </div>
        </div>                               
    </div>
   ...
   useEffect(() => {
    ...
    const cseContent= CseBoard.map(()=> {
        ...
        return (   
            <div key={cse_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>{"Entry #"+(cse_ctr+1)}</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Career Service/ RA 1080 (Board/Bar) Under Special Laws/CES/CSEE</span>
                        <span>{CseBoard[cse_ctr] == '' ? "N/A" : CseBoard[cse_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Rating</span>
                        <span>{CseRating[cse_ctr] == '' ? "N/A" : CseRating[cse_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                    ...
                    <div className='span_cont'>
                        ...
                        <span>{CsePlaceExam[cse_ctr] == '' ? "N/A" :CsePlaceExam[cse_ctr] }</span>
                    </div>
                </div>
                <div className='left'>
                    <p style={{marginTop:"-25px",fontWeight:"600",fontSize:"1.2rem",color:"#FFAA28",marginBottom:"10px"}}>License (if applicable)</p>

                    <div className='span_cont' style={{marginLeft:"15px"}}>
                        <span> Number</span>
                        <span>- {CseLicense[cse_ctr] == '' ? "N/A" :CseLicense[cse_ctr] }</span>
                    </div>
                    <div className='span_cont' style={{marginLeft:"15px"}}>
                    <span>Date of Validity</span>
                    <span>- {CseDateVal[grad_ctr] == '' ? "N/A" :CseDateVal[cse_ctr] }</span>
                    </div>
                </div>
            </div>                               
        </div>
...
const weContent= wePosition.map(()=> {
    ...
    return (   
        <div key={we_ctr}>
        <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>{"Entry #"+(we_ctr+1)}</p>
        <div className='content'>
            <div className='left'>
                <div className='span_cont' style={{marginTop:"-20px"}}>
                ...
                <div className='span_cont'>
                    ...
                    <span>{wePosition[we_ctr] == '' ? "N/A" : wePosition[we_ctr] }</span>
                </div>
                <div className='span_cont'>
                    <span>Department / Agency / Office / Company</span>
                    <span>{weDepartment[we_ctr] == '' ? "N/A" :weDepartment[we_ctr] }</span>
                </div>
            </div>
            <div className='left'>
                <div className='span_cont' style={{marginTop:"-20px"}}>
   ...
   const loadldTo = async () =>{
     ...
     var sliceldTo = inputldTo.slice(0, -5);
...
var resultYear = yearToday-splitDate[0];
    ...
    if(resultYear<=5){
        ...
        return (   
            <div key={ld_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>{"Entry #"+(landCtr)}</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                    ...
                    <div className='span_cont'>
                        ...
                        <span>{ldHours[ld_ctr] == '' ? "N/A" :ldHours[ld_ctr]+" HRS" }</span>
                    </div>
                </div>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                    ...
                    <div className='span_cont'>
                        ...
                        <span>{ldSponsor[ld_ctr] == '' ? "N/A" :ldSponsor[ld_ctr] }</span>
                    </div>
                    <div className='span_cont'>
                        <span>Coverage (International / National / Regional / Local)</span>
                        <span>{ldCoverage[ld_ctr] == '' ? "N/A" :ldCoverage[ld_ctr] }</span>
                    </div>
                </div>
            </div>                               
        </div>
        ...
        return (   
            <div key={ld_ctr}>
            <p style={{fontWeight:"bold",color:"#FFAA28",fontSize:"1.4rem", marginLeft:"10%",marginTop:"10px"}}>{"Entry #"+1}</p>
            <div className='content'>
                <div className='left'>
                    <div className='span_cont' style={{marginTop:"-20px"}}>
                        <span>Title of learning and development interventions/ training programs</span>
 ...
 function pds1_go(){
    ...
    document.getElementsByClassName("box1go")[0].style.backgroundColor="#fbce8b";
    document.getElementsByClassName("box1go")[0].style.borderLeft="5px solid rgb(254, 138, 60)";
    ...
    document.getElementsByClassName("box5go")[0].style.backgroundColor="transparent";
    document.getElementsByClassName("box5go")[0].style.borderLeft="0px solid #ffff";
 ...
 function pds2_go(){
    ...
    document.getElementsByClassName("box2go")[0].style.backgroundColor="#fbce8b";
    document.getElementsByClassName("box2go")[0].style.borderLeft="5px solid rgb(254, 138, 60)";
 ...
 function pds3_go(){
    ...
    document.getElementsByClassName("box3go")[0].style.backgroundColor="#fbce8b";
    document.getElementsByClassName("box3go")[0].style.borderLeft="5px solid rgb(254, 138, 60)";
 ...
 function pds4_go(){
    ...
    document.getElementsByClassName("box4go")[0].style.backgroundColor="#fbce8b";
    document.getElementsByClassName("box4go")[0].style.borderLeft="5px solid rgb(254, 138, 60)";
                         ...
                         <div className='view_pds_container'>
                            <div className='top_cover' style={{backgroundImage: `url(${cover_banner})`}}>
                               ...
                               <div className='left'>
                                    <Avatar 
                                        ...
                                        src={profile_photo} 
                                        sx={{ bgcolor: deepOrange[600] , width: "200px", height: "200px", fontSize: "5rem", border  : "2px solid #ffff",borderRadius:"5px"}}
                                        variant="square"
                                        >
                                        {initialName}
                                    </Avatar>
                            ...
                            <div className="web_pds_container">
                                <div className='side_tab_container'> 
                                    ...
                                    <div className='box active box1go'><img src={basic_info}/></div>
                                    </LightTooltip>

                                    <LightTooltip title='Educational Background' onClick={pds2_go}>
                                    <div className='box box2go' ><img src={education_info}/></div>
                                    </LightTooltip>

                                    <LightTooltip title='Civil Service Eligibility' onClick={pds3_go}>
                                    <div className='box box3go'><img src={service_info}/></div>
                                    </LightTooltip>

                                    <LightTooltip title='Work Experience' onClick={pds4_go}>
                                    <div className='box box4go'><img src={work_info}/></div>
                                    </LightTooltip>

                                    <LightTooltip title='Learning and Development (L&D)'  onClick={pds5_go}>
                                    <div className='box box5go'><img src={LandD_info}/></div>
                                    </LightTooltip>
                                </div>
                                ...
                                <div className='right_content'>
                                    ...
                                    <div className='pds_2' style={{display:"none"}}>
                                        <div className="row1" style={{display:"flex",flexDirection:"column"}}>
                                            <div className='box row1_content' style={{width:"100%",marginBottom:"20px"}}>
                                                <div className='top'>
