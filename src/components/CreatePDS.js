...
<p className='p_consent' style={{visibility:"hidden"}}>By accepting, you acknowledge that you have read this form, understood its contents, and consent to the processing of your data for the purposes indicated in this Consent Form. If not, your data will not be used by Bulacan State University as long as your authorization to deny access has not been reversed.</p>
                ...
                <div className='stepper_container'>
                       <Link to="/FacultyDashboard" style={{ textDecoration: 'none',marginLeft:"5%"}} className="back_stepper0">
                        ...
                        <button type='button' className='back_stepper back_stepper6' style={{display:"none"}} onClick={back6_stepper}>&#8592; &nbsp;&nbsp;&nbsp; Back</button>
                        ...
                        <button type='submit' className='next_stepper next_stepper6' style={{display:"none"}} onMouseOver={() => {sameAddressFunction();getAllElementaryInput();getAllCSEinput();getAllWEinput();getAllLDinput();}} >Submit &nbsp;&nbsp;&nbsp; &#8594;</button>
                </div>
